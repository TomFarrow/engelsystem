...
function admin_user() {
  ...
  if (! isset($_REQUEST['action'])) {
    ...
    $html .= "<tr><td>\n";
    $html .= "<table>\n";
    $html .= "  <tr><td>Username</td><td>" . "<input type=\"text\" size=\"40\" name=\"eNick\" value=\"" . $user_source['Nick'] . "\"></td></tr>\n";
    ...
    $html .= "  <tr><td>Slack</td><td>" . "<input type=\"text\" size=\"40\" name=\"ejabber\" value=\"" . $user_source['jabber'] . "\"></td></tr>\n";
    ...
    $html .= "Reset Password:<form action=\"" . page_link_to("admin_user") . "&action=change_pw&id=$user_id\" method=\"post\">\n";
    $html .= "<table>\n";
    $html .= "  <tr><td>Password</td><td>" . "<input type=\"password\" size=\"40\" name=\"new_pw\" value=\"\"></td></tr>\n";
    $html .= "  <tr><td>Confirm</td><td>" . "<input type=\"password\" size=\"40\" name=\"new_pw2\" value=\"\"></td></tr>\n";
    ...
    if ($user_id != $user['UID'] && $my_highest_group <= $his_highest_group) {
      $html .= "Volunteer User Groups: <form action=\"" . page_link_to("admin_user") . "&action=save_groups&id=" . $user_id . "\" method=\"post\">\n";
      $html .= '<table>';
