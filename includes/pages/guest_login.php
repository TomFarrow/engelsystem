...
function guest_register() {
  ...
  return page_with_title(register_title(), [
      _("By completing this form you're registering as a volunteer. This will create you an account in the volunteer task scheduler."),
      $msg,
      msg(),
      form([
          div('row', [
              div('col-md-6', [
                  ...
                  form_info("", _("Shifting is flexible. You can select most roles but some may need to be confirmed by a team leader."))
              ]),
              div('col-md-6', [
                  div('row', [
                      div('col-sm-4', [
